...
print(files <- list.files(path= "./output/bedtools", pattern="test.bam.hist.all.txt", full.names = TRUE))
...
png("./output/bedtools/exome-coverage-plots.png", h=1000, w=1000, pointsize=20)
