...
VariantFiltration = ["java", "-jar", "/usr/share/java/GenomeAnalysisTK-3.8.0.jar", "-T", "VariantFiltration"]
...
Mutect2 = ["java", "-jar", "/usr/share/java/GenomeAnalysisTK-3.8.0.jar", "-T", "MuTect2"]
...
# PANEL OF NORMALS--MUTECT2 (gatk 4)
# =====================================================================
rb_intervals = "bin/rb.bed"
mutect2_pon_vcf=mutect2_output_dir+r1_base_filename+"_pon_mutect2.vcf"
mutect2_pon_bamout=mutect2_output_dir+r1_base_filename+"_pon_mutect2.bamout"
...
if((not "skip_strelka" in steps_to_process) and ("strelka" in steps_to_process)):
...
if ("N" in r1_base_filename):
	mutect2_vcf = mutect2_pon_vcf
if("variantfiltration" in steps_to_process):
...
# ====================================================================
mutect2_vep_anno_vcf = mutect2_output_dir+r1_base_filename+"_mutect2_vep.vcf"
if("mutect2_vep" in steps_to_process):
	...
	cmd += ["-i", mutect2_anno_vcf]
	cmd += ["-o", mutect2_vep_anno_vcf]
	print " ".join(cmd)
	log_file = mutect2_output_dir +r1_base_filename+"_snv_vcf_vep.log"
	with open(mutect2_vep_anno_vcf,"wb") as outf, open(log_file, "wb") as outerr:
...
# ====================================================================
strelka_vep_anno_vcf = strelka_output_dir+r1_base_filename+"_strelka_snv_vep.vcf.gz"
...
# ====================================================================
strelka_vep_anno_vcf = strelka_output_dir+r1_base_filename+"_strelka_indel_vep.vcf.gz"
