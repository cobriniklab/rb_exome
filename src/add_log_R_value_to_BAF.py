...
sample_snps = pd.read_csv(sys.argv[2],names=["Chr","Position","End",sample_name+"GType",sample_name+"B Allele Freq"],sep="\t", index_col=False, skiprows=1, low_memory=False, header=0)
reference_snps = pd.read_csv(sys.argv[3],names=["Chr","Position","End",reference_name+"GType",reference_name+"B Allele Freq"],sep="\t", index_col=False, skiprows=1, low_memory=False, header=0)
sample_snps.drop(columns=["End"], inplace=True)
reference_snps.drop(columns=["End"], inplace=True)
